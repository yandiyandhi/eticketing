...
$(function () {
    ...
    if (dt_filter_table.length) {
        ...
        var dt_filter = dt_filter_table.DataTable({
            ajax: {
                url: assetsPath + "json/data-ticketing.json",
                dataSrc: "data",
            },
            columns: [
                { data: "id" },
            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, full) {
                        ...
                        var map = {
                            Open: { title: "Open", class: "bg-label-primary" },
                            "On Progress": {
                                title: "On Progress",
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        return (
                            ...
                            "</div>" +
                            '<div class="btn btn-sm btn-text-secondary rounded-pill btn-icon ms-2 edit-record">' +
                            '<i class="ti ti-pencil-alt ti-md"></i>' +
                            "</div>"
                        );
                    },
                },
